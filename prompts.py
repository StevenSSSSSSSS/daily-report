...
- 每個 buy 必須提供：action、ticker、name、trade_type、reason、allocation_usd、entry_plan、stop、target、trailing_stop、thesis、evidence、falsification_points、review_trigger。
